...
const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      ...
      staleTime: process.env.NODE_ENV === 'development' ? 1000 * 60 * 5 : 1000 * 60 * 10, // 5 min in dev, 10 min in prod
      gcTime: process.env.NODE_ENV === 'development' ? 1000 * 60 * 10 : 1000 * 60 * 15, // 10 min in dev, 15 min in prod
